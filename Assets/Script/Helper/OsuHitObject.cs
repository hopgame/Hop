...
public class MHitObject : HitObjectBase {
    public static int MaxTrackAnchor = 512;
    public static int MinTrackAnchor = 0;
    public override Vector2 EndPosition { get; set; }
    public override int ComboNumber { get; set; }

    public int GetTrackIndex(int trackCount) {
        return (int) (this.Position.x/(int)(MaxTrackAnchor/trackCount));
    }

    public bool IsHold() {
        return this.IsType(HitObjectType.Hold);
    }
}
